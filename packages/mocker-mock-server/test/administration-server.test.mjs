...
const test = async () => {
  try {
    ...
    try {
      ...
      expect(metricsAfterRequest1.data.requestsPerRule['test_glob']['../rules/test_rule_1.yaml']).to.equal(1)
      ...
      expect(metricsAfterRequest2toSameRule.data.requestsPerRule['test_glob']['../rules/test_rule_1.yaml']).to.equal(2)
      ...
      expect(metricsAfterRequestToAnotherRule.data.requestsPerRule['test_glob']['../rules/test_rule_1.yaml']).to.equal(2)
      expect(metricsAfterRequestToAnotherRule.data.requestsPerRule['test_glob']['../rules/test_rule_2.yaml']).to.equal(1)
      ...
      expect(metricsAfterStartMockServerForOtherProject.data.requestsPerRule['test_glob']['../rules/test_rule_1.yaml']).to.equal(2)
      expect(metricsAfterStartMockServerForOtherProject.data.requestsPerRule['test_glob']['../rules/test_rule_2.yaml']).to.equal(1)
      ...
      expect(metricsAfterAfterRequestToMockServerForOtherProject.data.requestsPerRule['test_glob']['../rules/test_rule_1.yaml']).to.equal(3)
      expect(metricsAfterAfterRequestToMockServerForOtherProject.data.requestsPerRule['test_glob']['../rules/test_rule_2.yaml']).to.equal(1)
      expect(metricsAfterAfterRequestToMockServerForOtherProject.data.requestsPerRule['test_multiple_glob']['../rules/test_rule_1.yaml']).to.equal(1)
    } finally {
