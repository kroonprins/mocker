...
Using ES6 code from CommonJS code is possible with the dynamic import statement. As dynamic import is async this is less straightforward as using require() to import another CommonJS dependency.
