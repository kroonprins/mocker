...
class Mocker {
  ...
  startMockServer () {
    if (!config.getProperty('project')) {
      throw new Error('The project must be set when starting the mock server')
    }
    config
  ...
  startLearningModeReverseProxyServer () {
    if (!config.getProperty('project')) {
      throw new Error('The project must be set when starting the learning mode reverse proxy server')
    }
  ...
  startLearningModeForwardProxyServer () {
    if (!config.getProperty('project')) {
      throw new Error('The project must be set when starting the learning mode forward proxy server')
    }
    config
