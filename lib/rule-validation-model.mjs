...
class RuleValidationModel extends ValidationModel {
  constructor (configService = config.getInstance(ConfigService), latencySerializationModel = config.getInstance(LatencyValidationModel)) {
    super()
    this[Request] = {
    ...
    this[Rule] = {
      ...
      'Rule': {
        ...
        'properties': {
          ...
          'fixedLatency': {
            '$ref': `${latencySerializationModel[FixedLatency].$id}#/FixedLatency`
          },
          'randomLatency': {
            '$ref': `${latencySerializationModel[RandomLatency].$id}#/RandomLatency`
          }
        },
        'required': [
