...
class MockServer extends Server {
   ...
   * @param {MockServerSwaggerUiServer} [swaggerUiServer=config.getOptionalInstance(MockServerSwaggerUiServer)] The swagger UI server
   * @memberof MockServer
   */
  constructor (port = config.getProperty('mock-server.port'),
    ...
    watchConfigurationChanges = config.getProperty('mock-server.watch-for-configuration-changes'),
    enableSwaggerUI = config.getProperty('mock-server-swagger-ui.enabled'),
    swaggerUiServer = config.getOptionalInstance(MockServerSwaggerUiServer)) {
    ...
    this.swaggerUiServer = swaggerUiServer
  }
