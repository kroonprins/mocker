...
class InMemoryProjectStore {
  ...
  async createNewProject (projectName) {
    ...
    await this._syncProjectsFileToFileSystem()
    return project
  }
...
const ProjectService = {
  ...
  listProjectRules: async (projectName) => {
  ...
  retrieveProjectRule: async (projectName, ruleName) => {
    ...
    return PROJECT_STORE.projectRule(projectName, ruleName)
  },
